...
/* Compability */
#ifndef PACKSTRUCT
// PACKED is defined in windef.h for MINGW without gcc_struct which causes problems.
...
enum ble_msg_idx {
  ...
  ble_cmd_flash_write_data_idx =22,
  ble_cmd_flash_read_data_idx =23,
  ble_cmd_attributes_write_idx =24,
  ble_cmd_attributes_read_idx =25,
  ble_cmd_attributes_read_type_idx =26,
  ble_cmd_attributes_user_read_response_idx =27,
  ble_cmd_attributes_user_write_response_idx =28,
  ble_cmd_connection_disconnect_idx =29,
  ble_cmd_connection_get_rssi_idx =30,
  ble_cmd_connection_update_idx =31,
  ble_cmd_connection_version_update_idx =32,
  ble_cmd_connection_channel_map_get_idx =33,
  ble_cmd_connection_channel_map_set_idx =34,
  ble_cmd_connection_features_get_idx =35,
  ble_cmd_connection_get_status_idx =36,
  ble_cmd_connection_raw_tx_idx =37,
  ble_cmd_attclient_find_by_type_value_idx =38,
  ble_cmd_attclient_read_by_group_type_idx =39,
  ble_cmd_attclient_read_by_type_idx =40,
  ble_cmd_attclient_find_information_idx =41,
  ble_cmd_attclient_read_by_handle_idx =42,
  ble_cmd_attclient_attribute_write_idx =43,
  ble_cmd_attclient_write_command_idx =44,
  ble_cmd_attclient_indicate_confirm_idx =45,
  ble_cmd_attclient_read_long_idx =46,
  ble_cmd_attclient_prepare_write_idx =47,
  ble_cmd_attclient_execute_write_idx =48,
  ble_cmd_attclient_read_multiple_idx =49,
  ble_cmd_sm_encrypt_start_idx =50,
  ble_cmd_sm_set_bondable_mode_idx =51,
  ble_cmd_sm_delete_bonding_idx =52,
  ble_cmd_sm_set_parameters_idx =53,
  ble_cmd_sm_passkey_entry_idx =54,
  ble_cmd_sm_get_bonds_idx =55,
  ble_cmd_sm_set_oob_data_idx =56,
  ble_cmd_gap_set_privacy_flags_idx =57,
  ble_cmd_gap_set_mode_idx =58,
  ble_cmd_gap_discover_idx =59,
  ble_cmd_gap_connect_direct_idx =60,
  ble_cmd_gap_end_procedure_idx =61,
  ble_cmd_gap_connect_selective_idx =62,
  ble_cmd_gap_set_filtering_idx =63,
  ble_cmd_gap_set_scan_parameters_idx =64,
  ble_cmd_gap_set_adv_parameters_idx =65,
  ble_cmd_gap_set_adv_data_idx =66,
  ble_cmd_gap_set_directed_connectable_mode_idx =67,
  ble_cmd_hardware_io_port_config_irq_idx =68,
  ble_cmd_hardware_set_soft_timer_idx =69,
  ble_cmd_hardware_adc_read_idx =70,
  ble_cmd_hardware_io_port_config_direction_idx =71,
  ble_cmd_hardware_io_port_config_function_idx =72,
  ble_cmd_hardware_io_port_config_pull_idx =73,
  ble_cmd_hardware_io_port_write_idx =74,
  ble_cmd_hardware_io_port_read_idx =75,
  ble_cmd_hardware_spi_config_idx =76,
  ble_cmd_hardware_spi_transfer_idx =77,
  ble_cmd_hardware_i2c_read_idx =78,
  ble_cmd_hardware_i2c_write_idx =79,
  ble_cmd_hardware_set_txpower_idx =80,
  ble_cmd_hardware_timer_comparator_idx =81,
  ble_cmd_hardware_io_port_irq_enable_idx =82,
  ble_cmd_hardware_io_port_irq_direction_idx =83,
  ble_cmd_hardware_analog_comparator_enable_idx =84,
  ble_cmd_hardware_analog_comparator_read_idx =85,
  ble_cmd_hardware_analog_comparator_config_irq_idx =86,
  ble_cmd_test_phy_tx_idx =87,
  ble_cmd_test_phy_rx_idx =88,
  ble_cmd_test_phy_end_idx =89,
  ble_cmd_test_phy_reset_idx =90,
  ble_cmd_test_get_channel_map_idx =91,
  ble_cmd_test_debug_idx =92,
  ble_cmd_test_channel_mode_idx =93,
  ble_cmd_dfu_reset_idx =94,
  ble_cmd_dfu_flash_set_address_idx =95,
  ble_cmd_dfu_flash_upload_idx =96,
  ble_cmd_dfu_flash_upload_finish_idx =97,
  ble_rsp_system_reset_idx =98,
  ble_rsp_system_hello_idx =99,
  ble_rsp_system_address_get_idx =100,
  ble_rsp_system_reg_write_idx =101,
  ble_rsp_system_reg_read_idx =102,
  ble_rsp_system_get_counters_idx =103,
  ble_rsp_system_get_connections_idx =104,
  ble_rsp_system_read_memory_idx =105,
  ble_rsp_system_get_info_idx =106,
  ble_rsp_system_endpoint_tx_idx =107,
  ble_rsp_system_whitelist_append_idx =108,
  ble_rsp_system_whitelist_remove_idx =109,
  ble_rsp_system_whitelist_clear_idx =110,
  ble_rsp_system_endpoint_rx_idx =111,
  ble_rsp_system_endpoint_set_watermarks_idx =112,
  ble_rsp_flash_ps_defrag_idx =113,
  ble_rsp_flash_ps_dump_idx =114,
  ble_rsp_flash_ps_erase_all_idx =115,
  ble_rsp_flash_ps_save_idx =116,
  ble_rsp_flash_ps_load_idx =117,
  ble_rsp_flash_ps_erase_idx =118,
  ble_rsp_flash_erase_page_idx =119,
  ble_rsp_flash_write_data_idx =120,
  ble_rsp_flash_read_data_idx =121,
  ble_rsp_attributes_write_idx =122,
  ble_rsp_attributes_read_idx =123,
  ble_rsp_attributes_read_type_idx =124,
  ble_rsp_attributes_user_read_response_idx =125,
  ble_rsp_attributes_user_write_response_idx =126,
  ble_rsp_connection_disconnect_idx =127,
  ble_rsp_connection_get_rssi_idx =128,
  ble_rsp_connection_update_idx =129,
  ble_rsp_connection_version_update_idx =130,
  ble_rsp_connection_channel_map_get_idx =131,
  ble_rsp_connection_channel_map_set_idx =132,
  ble_rsp_connection_features_get_idx =133,
  ble_rsp_connection_get_status_idx =134,
  ble_rsp_connection_raw_tx_idx =135,
  ble_rsp_attclient_find_by_type_value_idx =136,
  ble_rsp_attclient_read_by_group_type_idx =137,
  ble_rsp_attclient_read_by_type_idx =138,
  ble_rsp_attclient_find_information_idx =139,
  ble_rsp_attclient_read_by_handle_idx =140,
  ble_rsp_attclient_attribute_write_idx =141,
  ble_rsp_attclient_write_command_idx =142,
  ble_rsp_attclient_indicate_confirm_idx =143,
  ble_rsp_attclient_read_long_idx =144,
  ble_rsp_attclient_prepare_write_idx =145,
  ble_rsp_attclient_execute_write_idx =146,
  ble_rsp_attclient_read_multiple_idx =147,
  ble_rsp_sm_encrypt_start_idx =148,
  ble_rsp_sm_set_bondable_mode_idx =149,
  ble_rsp_sm_delete_bonding_idx =150,
  ble_rsp_sm_set_parameters_idx =151,
  ble_rsp_sm_passkey_entry_idx =152,
  ble_rsp_sm_get_bonds_idx =153,
  ble_rsp_sm_set_oob_data_idx =154,
  ble_rsp_gap_set_privacy_flags_idx =155,
  ble_rsp_gap_set_mode_idx =156,
  ble_rsp_gap_discover_idx =157,
  ble_rsp_gap_connect_direct_idx =158,
  ble_rsp_gap_end_procedure_idx =159,
  ble_rsp_gap_connect_selective_idx =160,
  ble_rsp_gap_set_filtering_idx =161,
  ble_rsp_gap_set_scan_parameters_idx =162,
  ble_rsp_gap_set_adv_parameters_idx =163,
  ble_rsp_gap_set_adv_data_idx =164,
  ble_rsp_gap_set_directed_connectable_mode_idx =165,
  ble_rsp_hardware_io_port_config_irq_idx =166,
  ble_rsp_hardware_set_soft_timer_idx =167,
  ble_rsp_hardware_adc_read_idx =168,
  ble_rsp_hardware_io_port_config_direction_idx =169,
  ble_rsp_hardware_io_port_config_function_idx =170,
  ble_rsp_hardware_io_port_config_pull_idx =171,
  ble_rsp_hardware_io_port_write_idx =172,
  ble_rsp_hardware_io_port_read_idx =173,
  ble_rsp_hardware_spi_config_idx =174,
  ble_rsp_hardware_spi_transfer_idx =175,
  ble_rsp_hardware_i2c_read_idx =176,
  ble_rsp_hardware_i2c_write_idx =177,
  ble_rsp_hardware_set_txpower_idx =178,
  ble_rsp_hardware_timer_comparator_idx =179,
  ble_rsp_hardware_io_port_irq_enable_idx =180,
  ble_rsp_hardware_io_port_irq_direction_idx =181,
  ble_rsp_hardware_analog_comparator_enable_idx =182,
  ble_rsp_hardware_analog_comparator_read_idx =183,
  ble_rsp_hardware_analog_comparator_config_irq_idx =184,
  ble_rsp_test_phy_tx_idx =185,
  ble_rsp_test_phy_rx_idx =186,
  ble_rsp_test_phy_end_idx =187,
  ble_rsp_test_phy_reset_idx =188,
  ble_rsp_test_get_channel_map_idx =189,
  ble_rsp_test_debug_idx =190,
  ble_rsp_test_channel_mode_idx =191,
  ble_rsp_dfu_reset_idx =192,
  ble_rsp_dfu_flash_set_address_idx =193,
  ble_rsp_dfu_flash_upload_idx =194,
  ble_rsp_dfu_flash_upload_finish_idx =195,
  ble_evt_system_boot_idx =196,
  ble_evt_system_debug_idx =197,
  ble_evt_system_endpoint_watermark_rx_idx =198,
  ble_evt_system_endpoint_watermark_tx_idx =199,
  ble_evt_system_script_failure_idx =200,
  ble_evt_system_no_license_key_idx =201,
  ble_evt_system_protocol_error_idx =202,
  ble_evt_flash_ps_key_idx =203,
  ble_evt_attributes_value_idx =204,
  ble_evt_attributes_user_read_request_idx =205,
  ble_evt_attributes_status_idx =206,
  ble_evt_connection_status_idx =207,
  ble_evt_connection_version_ind_idx =208,
  ble_evt_connection_feature_ind_idx =209,
  ble_evt_connection_raw_rx_idx =210,
  ble_evt_connection_disconnected_idx =211,
  ble_evt_attclient_indicated_idx =212,
  ble_evt_attclient_procedure_completed_idx =213,
  ble_evt_attclient_group_found_idx =214,
  ble_evt_attclient_attribute_found_idx =215,
  ble_evt_attclient_find_information_found_idx =216,
  ble_evt_attclient_attribute_value_idx =217,
  ble_evt_attclient_read_multiple_response_idx =218,
  ble_evt_sm_smp_data_idx =219,
  ble_evt_sm_bonding_fail_idx =220,
  ble_evt_sm_passkey_display_idx =221,
  ble_evt_sm_passkey_request_idx =222,
  ble_evt_sm_bond_status_idx =223,
  ble_evt_gap_scan_response_idx =224,
  ble_evt_gap_mode_changed_idx =225,
  ble_evt_hardware_io_port_status_idx =226,
  ble_evt_hardware_soft_timer_idx =227,
  ble_evt_hardware_adc_result_idx =228,
  ble_evt_hardware_analog_comparator_status_idx =229,
  ble_evt_dfu_boot_idx =230
};
...
/*
struct ble_msg_attclient_attribute_value_evt_t { uint8 connection; uint16 atthandle; uint8 type; uint8array value; } __attribute__ ((gcc_struct, packed))
